        ...
        $(document).ready(function () {
            ...
            var user_table = $('#users-table').DataTable({
                ...
                columns: [
                    ...
                    {
                        data: function (data) {
                            return data.channels.length + ' canales';
                        }
                    },
                    {data: 'created_at'},
    ...
    <div class="box box-info">
        <div class="box-header with-border">
            ...
            <div class="pull-right box-tools">
                ...
                <a href="{{ route('plan.create')}}" class="btn btn-success btn-sm"
        ...
        <div class="box-body">
            ...
            <table id="users-table" class="table table-bordered table-striped dataTable" cellspacing="0"
                ...
                <tr>
                    ...
                    <th data-priority="5">Canales</th>
                    <th data-priority="6">Fecha Creacion</th>
